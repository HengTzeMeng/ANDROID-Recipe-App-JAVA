...
import com.example.ahmarecipe.interfaces.GetDataService
import com.example.ahmarecipe.retofitclient.RetrofitClientInstance
...
//var youtubeLink is "More Info" in details page
    var youtubeLink = ""
...
//The More info button not showing, if the api lack of certain instruction
